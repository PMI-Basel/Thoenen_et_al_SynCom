...
ggsave(plot = MBOA_met_SynCom_Timeseries, filename = "Fig_1B_MBOA_met_SynCom_Timeseries.svg", path = "../../all_figures", width=6, height=6, dpi = 300, scale = 1, units = "cm")
```
...
ggsave(plot = MBOA_met_LMX9_Timeseries, filename = "Fig_S3C_MBOA_met_LMX9_Timeseries.svg", path = "../../all_figures", width=6, height=4, dpi = 300, scale = 1, units = "cm")
```
...
Time_SynCom_met <- met %>% 
  ...
  scale_fill_manual(values = c("darkred", "gold2", "darkblue")) +
...
ggsave(plot = Time_SynCom_met, filename = "Fig_S4A_Time_SynCom_met.pdf", path = "../../all_figures", width = 12, height = 6, dpi = 300, scale = 1, units = "cm")

ggsave(plot = Time_SynCom_met, filename = "Fig_S4A_Time_SynCom_met.svg", path = "../../all_figures", width = 12, height = 6, dpi = 300, scale = 1, units = "cm")
```
